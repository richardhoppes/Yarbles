...
class FeedWriter
{
    ...
    function __construct($version = RSS2)
    {
        ...
        //Added 'content' and 'subtitle' as an encoded tag
        $this->CDATAEncoding = array('description', 'content:encoded', 'summary', 'content', 'subtitle');
    }
    ...
    private function printChannels()
    {
        ...
        foreach ($this->channels as $key => $value)
        {
            if($this->version == ATOM && $key == 'link')
            {
                ...
                // Temp fix, adding rel=self for link element
                echo $this->makeNode($key,'',array('href'=>$value, 'rel'=>'self'));
                //Add the id for ATOM
