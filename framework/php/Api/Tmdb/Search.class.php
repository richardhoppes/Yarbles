...
class Api_Tmdb_Search extends Api_Tmdb {
	...
	protected function parseResponse($strResponse, $strMethod) {
		$objReturn = new Api_Tmdb_Entity_SearchResponse();
			...
			foreach($objParsedResponse->results as $objResponse) {
				switch($strMethod) {
					case self::SEARCH_MOVIE_METHOD:
						$arrResults[] = Api_Tmdb_Utility_TransformSearchResponse::transformSearchMovieResponse($objResponse);
						break;
					case self::SEARCH_PERSON_METHOD:
						$arrResults[] = Api_Tmdb_Utility_TransformSearchResponse::transformSearchPersonResponse($objResponse);
						break;
					case self::SEARCH_COMPANY_METHOD:
						$arrResults[] = Api_Tmdb_Utility_TransformSearchResponse::transformSearchCompanyResponse($objResponse);
						break;
				}
			}
